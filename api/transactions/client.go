...
func (c *Client) Verify(
	ctx context.Context,
	request *sdk.TransactionsVerifyRequest,
	opts ...option.RequestOption,
) (*sdk.TransactionsVerifyResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *sdk.TransactionsVerifyResponse
...
func (c *Client) Get(
	...
	opts ...option.RequestOption,
) (*sdk.TransactionWithRulesResult, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *sdk.TransactionWithRulesResult
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
