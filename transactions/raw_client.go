...
func (r *RawClient) Verify(
...
) (*core.Response[*flagrightgo.TransactionsVerifyResponse], error) {
	...
	return &core.Response[*flagrightgo.TransactionsVerifyResponse]{
...
func (r *RawClient) Get(
	...
	opts ...option.RequestOption,
) (*core.Response[*flagrightgo.TransactionWithRulesResult], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	return &core.Response[*flagrightgo.TransactionWithRulesResult]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
